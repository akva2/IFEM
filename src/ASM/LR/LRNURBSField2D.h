...
//==============================================================================
//!
//! \file LRNURBSField2D.h
//!
//! \date Apr 23 2023
//!
//! \author Arne Moreten Kvarving / SINTEF
//!
//! \brief Class for LR NURBS-based finite element scalar fields in 2D.
//!
//==============================================================================

#ifndef _LRNURBS_FIELD_2D_H
#define _LRNURBS_FIELD_2D_H
...
class LRNURBSField2D : public FieldBase
{
public:
  ...
  LRNURBSField2D(const ASMu2D* patch, const RealArray& v,
  ...
  //! \param[in] v Array of control point field values
  //! \param[in] name Name of spline field
  LRNURBSField2D(const LR::LRSplineSurface* srf, const RealArray& v,
                 const char* name = nullptr);
  //! \brief Empty destructor.
  virtual ~LRNURBSField2D() {}
