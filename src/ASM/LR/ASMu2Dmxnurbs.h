...
#ifndef _ASM_U2DN_MX_H
#define _ASM_U2DN_MX_H
...
/*!
  \brief Driver for assembly of unstructured 2D nurbs mixed FE models.
  \details This class implements a mixed formulation with splines as
  ...
  The geometry is represented by a nurbs basis,
*/

class ASMu2Dmxnurbs : public ASMu2Dnurbs, private ASMmxBase
{
public:
  //! \brief The constructor initializes the dimension of each basis.
  ASMu2Dmxnurbs(unsigned char n_s, const CharVec& n_f);
  //! \brief Copy constructor.
  ASMu2Dmxnurbs(const ASMu2Dmxnurbs& patch, const CharVec& n_f = CharVec(2,0));
  //! \brief Empty destructor.
  virtual ~ASMu2Dmxnurbs() { lrspline = nullptr; geo = nullptr; }
  ...
  using ASMu2Dnurbs::evalSolution;
...
protected:
  using ASMu2Dnurbs::generateThreadGroups;
