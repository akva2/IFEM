...
bool ASMu2D::transferGaussPtVars (const LR::LRSpline* oldBasis1,
                                  const RealArray& oldVars, RealArray& newVars,
                                  int nGauss) const
{
  const LR::LRSplineSurface* newBasis = this->getBasis();
  const LR::LRSplineSurface* oldBasis = static_cast<const LR::LRSplineSurface*>(oldBasis1);
...
bool ASMu2D::transferGaussPtVarsN (const LR::LRSpline* oldBasis1,
                                   const RealArray& oldVars, RealArray& newVars,
                                   int nGauss) const
{
  const LR::LRSplineSurface* newBasis = this->getBasis();
...
bool ASMu2D::transferCntrlPtVars (const LR::LRSpline* oldBasis1,
