...
public:
  ...
  virtual void getElmConnectivities(NeighArray& neighs) const;
  ...
  //! \param[in] orient Orientation of boundary (used for sorting)
  //! \param elms Array of element numbers
...
protected:
  ...
  //! \brief Generate element groups from an element list.
  virtual void generateThreadGroupsFromElms(const std::vector<int>& filter);
