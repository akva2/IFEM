...
public:
  ...
  {
    ISTL::BlockPreconditioner::extractBlock(B, A, eqs_row, eqs_col);
  }
};
...
TEST(TestISTLMatrix, AssembleBasisBlocks)
{
  ...
  block.extractBlock(mat[0], A, adm.dd.getBlockEqs(0), adm.dd.getBlockEqs(0));
  block.extractBlock(mat[1], A, adm.dd.getBlockEqs(0), adm.dd.getBlockEqs(1));
  block.extractBlock(mat[2], A, adm.dd.getBlockEqs(1), adm.dd.getBlockEqs(0));
  block.extractBlock(mat[3], A, adm.dd.getBlockEqs(1), adm.dd.getBlockEqs(1));
