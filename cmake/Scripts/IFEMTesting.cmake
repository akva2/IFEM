...
macro(IFEM_add_test_app path workdir name)
  ...
  if(NOT PETSC_FOUND)
    list(REMOVE_ITEM TEST_SRCS ${IFEM_PATH}/src/LinAlg/Test/TestPETScMatrix.C)
    list(REMOVE_ITEM TEST_SRCS ${IFEM_PATH}/src/LinAlg/Test/TestISTLPETScMatrix.C)
  endif()
  if(NOT ISTL_FOUND)
    list(REMOVE_ITEM TEST_SRCS ${IFEM_PATH}/src/LinAlg/Test/TestISTLMatrix.C)
    list(REMOVE_ITEM TEST_SRCS ${IFEM_PATH}/src/LinAlg/Test/TestISTLPETScMatrix.C)
  endif()
...
macro(IFEM_add_unittests IFEM_PATH)
  ...
  if(MPI_FOUND)
    ...
    if(NOT PETSC_FOUND)
      list(REMOVE_ITEM TEST_SRCS ${IFEM_PATH}/src/LinAlg/Test/MPI/TestPETScMatrix.C)
    endif()
    if(NOT ISTL_FOUND)
      list(REMOVE_ITEM TEST_SRCS ${IFEM_PATH}/src/LinAlg/Test/MPI/TestISTLMatrix.C)
    endif()
    if(TEST_SRCS)
