...
function(IFEM_add_restart_test name binary rlevel)
  ...
  if(IFEM_TEST_MEMCHECK)
    add_test("${test-name}" regtest.sh "${MEMCHECK_COMMAND} --log-file=${CMAKE_BINARY_DIR}/valgrindlog ${EXECUTABLE_OUTPUT_PATH}/${binary}" ${PROJECT_SOURCE_DIR}/${TEST_SUBDIR}/Test/${name} ${ARGN} ${rfile} ${rlevel})
  else(IFEM_TEST_MEMCHECK)
    add_test("${test-name}" regtest.sh ${EXECUTABLE_OUTPUT_PATH}/${binary} ${PROJECT_SOURCE_DIR}/${TEST_SUBDIR}/Test/${name} ${ARGN} ${rfile} ${rlevel})
  endif(IFEM_TEST_MEMCHECK)
endfunction()
