...
IF(IFEM_USE_LRSPLINES)
  ...
  IF(LRSpline_LIBRARIES AND LRSpline_INCLUDE_DIRS)
    IF(LRSPLINE_VERSION_MAJOR LESS 1 OR (LRSPLINE_VERSION_MAJOR EQUAL 1 AND LRSPLINE_VERSION_MINOR LESS 4))
      MESSAGE(STATUS "LR-spline library is out of date.
                      Found ${LRSPLINE_VERSION_MAJOR}.${LRSPLINE_VERSION_MINOR}.${LRSPLINE_VERSION_PATCH}, need at least 1.4.0.
                      Support not enabled")
      SET(LRSpline_LIBRARIES "")
      SET(LRSpline_INCLUDE_DIRS "")
    ELSE(LRSPLINE_VERSION_MAJOR LESS 1 OR (LRSPLINE_VERSION_MAJOR EQUAL 1 AND LRSPLINE_VERSION_MINOR LESS 4))
...
IF(IFEM_USE_HDF5)
  ...
  if(HDF5_FOUND)
    ...
    list(APPEND IFEM_DEFINITIONS -DHAS_HDF5)
  endif()
ENDIF(IFEM_USE_HDF5)
...
IF(IFEM_USE_SPR)
  ...
  IF(SPR_LIBRARIES)
    ...
    string(APPEND IFEM_BUILD_CXX_FLAGS " -DHAS_SPR")
    list(APPEND IFEM_DEFINITIONS -DHAS_SPR)
    IF(ASM_LIBRARIES)
      string(APPEND IFEM_BUILD_CXX_FLAGS " -DUSE_F77SAM")
      list(APPEND IFEM_DEFINITIONS -DUSE_F77SAM)
    ENDIF(ASM_LIBRARIES)
  ENDIF(SPR_LIBRARIES)
ENDIF(IFEM_USE_SPR)
...
set(IFEM_IOTEST_SCRIPT ${IFEM_PATH}/Apps/Common/scripts/iotest.sh.in)
